(function (root, factory) {
	...
	L.TileLayer.Provider.providers = {
		...
		OpenStreetMap: {
  	    ...
  	    Americana: {
		url: 'https://tiles.americana.dev/{variant}/{z}/{x}/{y}.png',
		options: {
		    attribution: '&copy; <a href="https://americana.mapdevs.com/">OSM Americana</a> contributors',
		    variant: 'tiles', // fixed path segment
		    maxZoom: 20
		},
		variants: {
		    Default: {
